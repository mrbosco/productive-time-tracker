...
| 2   | UI-2  | **Client, deal and section behind the service.** The service line becomes `project · service`, and the project name is a hover target revealing client, deal and section on three labelled lines. Dark tooltip, opening after a deliberate rest on the name rather than on the way past - 2 s, amended from the design's 200 ms. Tap opens it as a small sheet on mobile - hover is not a mobile affordance.                                                                                                                                               | the same request as UI-1                     | S      |
